...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.63.5
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.988
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/privatedns v1.0.988
