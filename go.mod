...
require (
	...
	github.com/civo/civogo v0.3.81
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.1014
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/privatedns v1.0.1014
