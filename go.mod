...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.62.452
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.703
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/privatedns v1.0.703
