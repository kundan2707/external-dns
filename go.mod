...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.1001
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/privatedns v1.0.1001
