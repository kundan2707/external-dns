...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.62.481
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.709
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/privatedns v1.0.709
