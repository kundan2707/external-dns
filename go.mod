...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.62.475
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.707
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/privatedns v1.0.707
