...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.63.37
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.1029
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/privatedns v1.0.1029
